...
export function SkipBackIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M6 5h2v14H6V5zm3.5 7l10.5 7V5L9.5 12z" />
    </svg>
  );
}
...
export function SkipForwardIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M16 5h2v14h-2V5zM4 5l10.5 7L4 19V5z" />
    </svg>
  );
}
...
export function UploadIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      <path d="M12 21V9M7 14l5-5 5 5M5 3h14" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
